        ...
        <div class="flex flex-wrap -mx-3">
            <div class="flex-none w-full max-w-full px-3">
                <div class="flex justify-end">
                    <div class="flex flex-col gap-3 lg:gap-0 md:items-center md:flex-row">
                        ...
                        <a href="{{ route('yatimPiatu.create') }}"
                                    ...
                                    @foreach ($yatims as $yatim)
                                        <tr>
                                            ...
                                            <td
                                                class="p-2 text-center align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
                                                <span
                                                    class="text-sm font-semibold leading-tight capitalize text-slate-800">{{ $yatim->nama }}</span>
                                            </td>

                                            <td
                                                class="p-2 text-center align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
                                                <span
                                                    class="text-sm font-semibold leading-tight capitalize text-slate-800">{{ $yatim->nama_ibu }}</span>
                                            </td>
                                            <td
                                                class="p-2 text-center align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
                                                <span
                                                    class="text-sm font-semibold leading-tight capitalize text-slate-800">{{ $yatim->nama_ayah }}</span>
                                            </td>
                                            <td
                                                class="p-2 text-center align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
                                                <span
                                                    class="text-sm font-semibold leading-tight capitalize text-slate-800">{{ $yatim->status }}</span>
                                            </td>
                                            <td
                                                class="p-2 text-center uppercase align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
                                                <span
                                                    class="text-sm font-semibold leading-tight text-slate-800">{{ $yatim->pendidikan }}</span>
                                            </td>
                                            <td
                                                class="p-2 text-center align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
                                                <span class="text-sm font-semibold leading-tight text-slate-800">Rp.
                                                    {{ number_format($yatim->biaya) }}</span>
                                            </td>

                                            <td class="flex p-2 align-middle border-b gap-x-2">
                                                <a href="{{ route('yatimPiatu.detail', $yatim->id_yatim_piatu) }}"
