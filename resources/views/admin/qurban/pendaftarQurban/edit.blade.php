            ...
            <div class="flex-none w-full max-w-full px-3">
                <div
                    ...
                    <div class="p-6 pb-0 mb-0 bg-white border-b-0 border-b-solid rounded-t-2xl border-b-transparent">
                        <h6>Edit Data Pendaftar Qurban</h6>
                    </div>
                                ...
                                <form class="grid grid-cols-4 gap-y-10 gap-x-4" method="post"
                                    ...
                                    <div>
                                        ...
                                        <select id="jenis_hewan" name="jenis_hewan"
                                            ...
                                            <option value="sapi" {{ $qurban->jenis_hewan == 'sapi' ? 'selected' : '' }}>
                                                Sapi</option>
                                            <option value="kerbau" {{ $qurban->jenis_hewan == 'kerbau' ? 'selected' : '' }}>
                                                kerbau</option>
                                            <option value="kambing"
                                                {{ $qurban->jenis_hewan == 'kambing' ? 'selected' : '' }}>Kambing</option>
                                            <option value="domba" {{ $qurban->jenis_hewan == 'domba' ? 'selected' : '' }}>
                                                Domba</option>
                                        </select>
                                    </div>
                                    <div>
