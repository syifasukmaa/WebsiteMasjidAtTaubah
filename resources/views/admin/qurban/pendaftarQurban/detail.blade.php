            ...
            <div class="flex-none w-full max-w-full px-3">
                <div
                    ...
                    <div class="p-6 pb-0 mb-0 bg-white border-b-0 border-b-solid rounded-t-2xl border-b-transparent">
                        <h6>Detail Data Pendaftar Qurban</h6>
                    </div>
                    <div class="flex-auto px-0 pt-0 pb-2">
                        <div class="p-6 overflow-x-auto">
                            <div class="dark:bg-gray-700">
                                <form class="grid grid-cols-4 gap-y-10 gap-x-4" method="get"
                                    ...
                                    @if ($qurban->jenis_hewan === 'sapi' || $qurban->jenis_hewan === 'kerbau')
                                        <div>
                                            ...
                                            <textarea id="tujuan_pahala" name="tujuan_pahala"
                                                class="block w-full px-0 text-sm text-gray-900 border-none rounded-lg bg-gray-50 dark:bg-gray-700 dark:text-white h-[80px]"
